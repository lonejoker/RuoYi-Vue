    ...
    handleFileSuccess(response, file, fileList) {
      ...
      debugger
			fetch(url)
				...
				.then((res) => {
					var suffix = row.filePath.substring(row.filePath.lastIndexOf("."), row.filePath.length);
					let blob = new Blob([res]);
					let url = window.URL.createObjectURL(blob);
					let a = document.createElement("a");
					a.style.display = "none";
					a.href = url;
					a.download = row.fileName + suffix;
					document.querySelectorAll("body")[0].appendChild(a);
					a.click();
					a.remove();
				});
			// https://www.jianshu.com/p/8185c0f6ae2e?utm_campaign=maleskine&utm_content=note&utm_medium=seo_notes&utm_source=recommendation
			// https://blog.csdn.net/weixin_45277714/article/details/108014066?spm=1001.2101.3001.6650.6&utm_medium=distribute.pc_relevant.none-task-blog-2%7Edefault%7EBlogCommendFromBaidu%7ERate-6.pc_relevant_default&depth_1-utm_source=distribute.pc_relevant.none-task-blog-2%7Edefault%7EBlogCommendFromBaidu%7ERate-6.pc_relevant_default&utm_relevant_index=10
			// https://blog.csdn.net/weixin_44075963/article/details/109084237?spm=1001.2101.3001.6650.5&utm_medium=distribute.pc_relevant.none-task-blog-2%7Edefault%7EBlogCommendFromBaidu%7ERate-5.pc_relevant_default&depth_1-utm_source=distribute.pc_relevant.none-task-blog-2%7Edefault%7EBlogCommendFromBaidu%7ERate-5.pc_relevant_default&utm_relevant_index=9
		}
  }
};
</script>
